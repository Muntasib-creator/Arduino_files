...
void read_sensor_values() {
  ...
  else if (IR_value_check(sensor, black)) {
    error = BLACK;
  }  //found Black
  else if (IR_value_check(sensor, err5)) {
    error = 5;
  } else if (IR_value_check(sensor, err4)) {
    error = 4;
  } else if (IR_value_check(sensor, err3)) {
    error = 3;
  } else if (IR_value_check(sensor, err33)) {
    error = 3;
  } else if (IR_value_check(sensor, err2)) {
    error = 2;
  } else if (IR_value_check(sensor, err1)) {
    error = 1;
  } else if (IR_value_check(sensor, err11)) {
    error = 1;
  } else if (IR_value_check(sensor, err0)) {
    error = 0;
  } else if (IR_value_check(sensor, err_1)) {
    error = -1;
  } else if (IR_value_check(sensor, err_11)) {
    error = -1;
  } else if (IR_value_check(sensor, err_2)) {
    error = -2;
  } else if (IR_value_check(sensor, err_3)) {
    error = -3;
  } else if (IR_value_check(sensor, err_33)) {
    error = -3;
  } else if (IR_value_check(sensor, err_4)) {
    error = -4;
  } else if (IR_value_check(sensor, err_5)) {
    error = -5;
  } else {
    error = 0;
  }
