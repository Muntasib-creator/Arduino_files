...
#define sensor3 5      // Middle Left sensor
#define sensor4 4      // Middle Right sensor
#define sensor5 3      // Right sensor
#define sensor6 2      // Right most sensor
#define sensor7 A0
#define sensor8 A1
...
void loop()
{
  ...
  if (error == 100) {               // Make left turn untill it detects straight path
    ...
    delay(DelayEvery);
    read_sensor_values();
    if ( (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 1) && (sensor[5] == 1) && (sensor[6] == 1) ) {
      stop_bot();
      delay(5000);
      do {
...
void read_sensor_values()
{
  ...
  sensor[0] = digitalRead(sensor3);
  sensor[1] = digitalRead(sensor4);
  sensor[2] = digitalRead(sensor5);
  sensor[3] = digitalRead(sensor6);
  sensor[4] = digitalRead(sensor7);
  sensor[5] = digitalRead(sensor8);
  ...
  rhs = sensor[3] + sensor[5] + sensor[5];
  lhs = sensor[0] + sensor[1] + sensor[2];


  if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 0) && (sensor[5] == 0)) // Turn robot left side
    error = 100;
